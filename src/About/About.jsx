        ...
        <div id='about' className='section-div'>
            ...
            <div className='about-content'>
                <div className='about-text'>
                    ...
                    <p>Outside of programming, I enjoy playing and listening to music, going to the gym, and reading. My current favorite band is Opeth and my current read is Frankenstein</p>
                </div>
